...
ADSP_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(ADSP_IMAGES)))
...
FIRMWARE_CMNLIB_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(FIRMWARE_CMNLIB_IMAGES)))
...
ISDB_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(ISDB_IMAGES)))
...
MBA_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(MBA_IMAGES)))
...
MC_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(MC_IMAGES)))
...
MODEM_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(MODEM_IMAGES)))
...
PROV_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(PROV_IMAGES)))
...
SECSTOR_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(SECSTOR_IMAGES)))
...
SKM_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(SKM_IMAGES)))
...
SKMM_TA_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(SKMM_TA_IMAGES)))
...
SSHDCPAP_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(SSHDCPAP_IMAGES)))
...
TZPR_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(TZPR_IMAGES)))
...
TZ_CCM_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(TZ_CCM_IMAGES)))
...
VENUS_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(VENUS_IMAGES)))
...
WCNSS_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(WCNSS_IMAGES)))
...
$(shell mkdir -p $(TARGET_COPY_OUT_VENDOR)/etc/firmware/wcd9306; \
    ln -sf /data/misc/audio/wcd9320_anc.bin \
    $(TARGET_COPY_OUT_VENDOR)/etc/firmware/wcd9306/wcd9306_anc.bin; \
    ln -sf /data/misc/audio/mbhc.bin \
    $(TARGET_COPY_OUT_VENDOR)/etc/firmware/wcd9306/wcd9306_mbhc.bin)
